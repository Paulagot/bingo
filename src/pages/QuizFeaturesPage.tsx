...
const FeatureCard: React.FC<{ icon: React.ReactNode; title: string; desc: string }> = ({ icon, title, desc }) => (
  <div className="group relative rounded-2xl border border-gray-100 bg-white p-6 shadow-sm hover:shadow-lg transition-all duration-300">
    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-600 to-purple-600 shadow-lg group-hover:shadow-xl transition-all duration-300">
...
const BenefitCard: React.FC<{ icon: React.ReactNode; title: string; desc: string; highlight?: boolean }> = ({ 
  icon, title, desc, highlight = false 
}) => (
  <div className={`group relative rounded-2xl border p-6 shadow-sm hover:shadow-lg transition-all duration-300 ${
    highlight ? 'border-gray-100 bg-gradient-to-br from-purple-50 to-indigo-50' : 'border-gray-100 bg-white'
  }`}>
    <div className={`mb-4 inline-flex h-12 w-12 items-center justify-center rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 ${
      highlight ? 'bg-gradient-to-br from-purple-500 to-pink-500' : 'bg-gradient-to-br from-indigo-600 to-purple-600'
    }`}>
      <div className="text-white">{icon}</div>
    </div>
    <h3 className="text-indigo-900 text-lg font-bold mb-2">{title}</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 to-white">
      ...
      <section className="relative px-4 pt-12 pb-8">
        ...
        <div className="container relative z-10 mx-auto max-w-6xl text-center">
          ...
          <p className="mt-2 text-2xl md:text-3xl font-semibold text-indigo-900">
            Transform Your Community Events
          </p>

          <p className="mx-auto mt-4 max-w-3xl text-indigo-900/70 text-lg md:text-xl">
            Discover how FundRaisely's comprehensive fundraising quiz platform revolutionizes community fundraising through innovative technology and proven engagement strategies. Our features are specifically designed to empower charities and non-profit organizations across Ireland and the UK to maximize their fundraising potential.
          </p>

          <div className="mt-7 flex flex-wrap justify-center gap-3">
            <a href="/free-trial" className="rounded-xl bg-indigo-700 px-6 py-3 text-white font-semibold shadow-md hover:bg-indigo-800 inline-flex items-center gap-2">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8">
            ...
            <p className="text-indigo-900/70 text-lg max-w-3xl mx-auto">
              Research shows that interactive fundraising events like quiz nights create stronger community bonds while generating significantly more revenue than traditional fundraising approaches.
            </p>
          </div>
      ...
      <section className="px-4 pt-12">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Transform your fundraising vision into reality with our intuitive setup wizard that eliminates technical barriers for volunteers.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Keep participants engaged and boost fundraising potential with innovative interactive features that create memorable experiences.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Support your community's preferred payment methods with comprehensive financial tracking and automated reconciliation.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Build stronger community partnerships and create lasting connections that extend beyond individual fundraising events.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Maintain the highest standards of financial transparency with comprehensive reporting tools that support charity governance requirements.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Ensure universal accessibility and reliable performance with our robust technical infrastructure designed for community organizations.</p>
      ...
      <section className="px-4 pt-8">
        <div className="container mx-auto max-w-6xl">
          <div className="rounded-2xl border border-gray-100 bg-white p-8 shadow-sm">
            ...
            <p className="text-indigo-900/70 text-lg mb-6">Built for real fundraising events with capacity that scales with your organization's growth and ambitions.</p>
      ...
      <section className="px-4 pt-12 pb-8">
        <div className="container mx-auto max-w-6xl">
          <h2 className="text-indigo-900 mb-8 text-3xl font-bold text-center">Fundraising Quiz Features — Frequently Asked Questions</h2>
          <div className="grid gap-6 md:grid-cols-2">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-indigo-900 mb-3 text-lg font-semibold">What makes FundRaisely different from other quiz platforms?</h3>
              <p className="text-indigo-900/70">
                FundRaisely is specifically designed for charity and non-profit fundraising with features like interactive fundraising extras, automated payment reconciliation, sponsor recognition, and audit-ready reporting that traditional quiz platforms lack.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-indigo-900 mb-3 text-lg font-semibold">How do the interactive fundraising extras work?</h3>
              <p className="text-indigo-900/70">
                Interactive extras like Freeze, Clue, Robin Hood, and Restore create additional revenue streams while maintaining engagement. Players can purchase these one-time-use items during gameplay to gain advantages or recover from mistakes.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-indigo-900 mb-3 text-lg font-semibold">Can we collect both cash and digital payments?</h3>
              <p className="text-indigo-900/70">
                Yes, FundRaisely supports flexible payment collection including cash, Revolut, and other instant payment methods. Admins can mark payments as received and specify the collection method, with automatic reconciliation updating in real-time.
              </p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-indigo-900 mb-3 text-lg font-semibold">What reporting features are available for charity compliance?</h3>
              <p className="text-indigo-900/70">
                FundRaisely provides comprehensive, audit-ready reports including financial reconciliation, gameplay statistics, sponsor recognition documentation. All reports can be exported for committee meetings and regulatory compliance.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-4 pt-8 pb-14">
        <div className="container mx-auto max-w-6xl text-center">
          <div className="rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white shadow-lg">
            <h3 className="text-3xl font-bold mb-3">Ready to Transform Your Community Fundraising?</h3>
            <p className="text-white/90 mb-6 text-lg max-w-3xl mx-auto">
              Experience the full power of FundRaisely's fundraising quiz platform with our comprehensive free trial. Start building stronger community connections while maximizing your fundraising potential today.
            </p>
