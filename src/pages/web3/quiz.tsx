...
const VideoSection: React.FC<{
  ...
  const videoId =
    videoKey === 'setup'     ? SETUP_VIDEO_ID :
    videoKey === 'dashboard' ? DASHBOARD_VIDEO_ID :
    videoKey === 'ingame'    ? INGAME_VIDEO_ID :
                               REPORTING_VIDEO_ID;
  ...
  const textCol = (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {steps.map(([t, d], i) => (
          <Step key={t} n={String(i + 1)} title={t} body={d} color={stepColor} bg={stepBg} />
        ))}
      </div>
    </div>
  );
  ...
  const LaunchButton: React.FC<{ size?: 'lg' | 'md' }> = ({ size = 'lg' }) => (
    <div className="flex flex-col items-start gap-2">
      <button
        ...
        disabled={isBusy}
        className={`inline-flex items-center gap-2 rounded-xl border border-[#a3f542]/40 bg-[#a3f542]/10 font-mono font-bold text-[#a3f542] transition hover:border-[#a3f542]/80 hover:bg-[#a3f542]/20 disabled:cursor-not-allowed disabled:opacity-60 ${
      ...
      >
        {isBusy ? (
          ...
          <><PlusCircle className="h-5 w-5" />Host a Quiz</>
        )}
      </button>
      {authError && (
          ...
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-4 font-mono text-3xl font-bold text-white">
                ...
                <span className="text-[#a3f542]">Round types to keep it interesting.</span>
              </h2>
              <p className="mx-auto mt-3 max-w-3xl text-white/50">
          ...
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <W3Card className="mx-auto max-w-2xl border-[#a3f542]/20">
              ...
              <p className="mt-4 text-center text-sm leading-relaxed text-white/40">
                For the quiz, there is a First and Second Prize only. First prize is 18% of the total pot.
                Second place is 12%. All recipients are paid simultaneously in a single contract execution
        ...
        <section className="relative z-10 py-12">
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-10 text-center">
              ...
              <h2 className="mt-4 font-mono text-3xl font-bold text-white">
                Live in minutes.{' '}
                <span className="text-[#a3f542]">No blockchain experience needed.</span>
              </h2>
              <p className="mx-auto mt-3 max-w-2xl text-white/50">
            ...
            <div className="space-y-16">
              <VideoSection
                ...
                steps={[
                  ['Set basic details',         'Choose your event name, select your chain, pick the fee token, choose a verified charity, and set the entry price.'],
                  ['Choose your quiz structure', 'Start from a quiz template and configure the event so it fits your crowd, pace, and fundraising goal.'],
                  ['Turn on fundraising extras', 'Enable optional paid extras like Freeze Out Player, Robin Hood, Clue, and Restore Points to add more revenue opportunities.'],
                  ['Review and launch',          'Review the full event, connect your wallet, and deploy the contract by signing. Your quiz is ready to host.'],
                ]}
              ...
              <VideoSection
                ...
                steps={[
                  ['Overview tab',              'See your event settings and a QR code players can scan to join from their own device.'],
                  ['Player panel',              'Track players in real time as they connect wallets, join, and prepare for the event.'],
                  ['Payments panel',            'See entry fee totals and monitor progress without manually chasing every payment.'],
                  ['Launch from the dashboard', 'Once your room is ready, launch directly into the live hosted game flow.'],
                ]}
              ...
              <VideoSection
                ...
                steps={[
                  ['Round intros',                     'Players see round intros with context, question counts, and what is coming next.'],
                  ['Asking phase',                     'Questions are timed so the event keeps moving while you stay in control as host.'],
                  ['Review and leaderboard',           'After each round, review answers, build suspense, and show the updated standings.'],
                  ['Tie-breaker support',              'Tie situations can be detected and handled cleanly so winners are clear and the finish feels fair.'],
                  ['Fundraising moments inside the game', 'Extras and round variety help the event feel live, strategic, and more valuable than a normal quiz.'],
                ]}
              ...
              <VideoSection
                ...
                steps={[
                  ['Final results',               'The leaderboard is shown, the winner is confirmed, and the event closes cleanly.'],
                  ['Smart contract distribution', 'Winner, host, charity, and platform are all paid in one contract execution according to the locked split.'],
                  ['Fundraising summary',         'Review totals, payout confirmation, and the full value created by the event.'],
                  ['Reporting and visibility',    'Use event outputs and statistics to show your community what was raised and how the event performed.'],
                ]}
        ...
        <section className="relative z-10 py-12">
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-4 font-mono text-3xl font-bold text-white">
                Solana and Base.{' '}
                <span className="text-[#a3f542]">Fast, low-cost, and built for live use.</span>
              </h2>
              <p className="mx-auto mt-3 max-w-2xl text-white/50">
        ...
        <section className="relative z-10 py-12">
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 text-center">
              ...
              <h2 className="mt-4 font-mono text-3xl font-bold text-white">
                Your community can trust it.{' '}
                <span className="text-[#a3f542]">Because the rules are visible.</span>
              </h2>
            </div>
          ...
          <div className="container mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
            <W3Card className="border-[#a3f542]/20 p-10 text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-white/50">
                Connect your wallet, list your event on the dashboard, use templates and round
                variety to run a stronger event for your community, then let the smart contract
                handle the payouts when the game ends.
              </p>
