...
export function IndexPageTemplate({ path, seoTitle, seoDescription, eyebrow, h1, intro, imageKey, cards, steps, faqs = [], relatedLinks = [] }: Props) {
  ...
  return (
    <>
      ...
      <Hero eyebrow={eyebrow} title={h1} description={intro} primaryCta={{ label: 'Book a demo',to: '/contact' }} secondaryCta={{ label: 'Explore features', to: '/features' }} image={images[imageKey]} variant="compact" />
