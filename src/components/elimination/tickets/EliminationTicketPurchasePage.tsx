...
// response and adapts all copy automatically. Nothing else needed here.
...
export const EliminationTicketPurchasePage: React.FC = () => {
      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-50 p-6">
        <div className="max-w-md rounded-2xl border border-red-200 bg-white p-6 text-center shadow-xl">
          ...
          <p className="mb-5 text-sm text-gray-600">
            This ticket link is missing the game room reference.
          </p>
...
export default EliminationTicketPurchasePage;