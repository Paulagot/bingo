        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-600">Join now, pay later in person (cash, card, Revolut)</div>
            </div>
        ...
        <>
          {showPayAdminOption && (
            <button
              ...
              onClick={() => {
                /* This will be handled by showing the methods */
              }}
            >
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-gray-600">Pay via Revolut link or bank transfer</div>
                </div>
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div
                        className={`flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br ${gradient} text-white shadow-md`}
                      >
                        {icon}
                      </div>
                      <div>
                        <div className="font-semibold text-gray-900 sm:text-lg">{method.methodLabel}</div>
