...
export const StripeWalkinSuccess: React.FC = () => {
  ...
  // We need the player name — it was in Stripe metadata but not passed back
  // Store it in sessionStorage before redirecting to Stripe
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-8">
      <div className="bg-white rounded-xl shadow-xl p-8 max-w-md text-center">
        ...
        <p className="text-gray-600 mb-2">Hi <strong>{playerName}</strong>, you're all paid up.</p>
        <p className="text-gray-500 text-sm mb-6">Click below to join the quiz now.</p>
        ...
        >
          {joining ? <Loader2 className="h-5 w-5 animate-spin mx-auto" /> : 'Join the Quiz Now 🎯'}
        </button>
      </div>
    </div>
  );
