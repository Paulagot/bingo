      ...
      <div className="container mx-auto max-w-6xl px-4 relative z-10">
        <div className="mb-12 text-center">
          ...
          <h2 className="text-white mb-4 text-3xl md:text-4xl font-bold mt-6">
            How FundRaisely Quiz 
            <span className="bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent"> Fundraisers </span>
            Work
          </h2>
          <p className="text-white/80 mx-auto max-w-2xl text-lg">
            From setup to payout — simple, transparent, repeatable.
          </p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 relative">
          {/* Connection lines for desktop */}
          <div className="hidden md:block absolute top-16 left-1/3 w-1/3 h-0.5 bg-gradient-to-r from-purple-400/60 to-indigo-400/60" />
          <div className="hidden md:block absolute top-16 right-0 w-1/3 h-0.5 bg-gradient-to-r from-indigo-400/60 to-pink-400/60 translate-x-1/3" />
          ...
          <div className="group relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-white mb-4 text-xl font-bold">Set up your Quiz Event</h3>
              <p className="text-white/80 text-base leading-relaxed">
                Choose a quiz template, set your fee, add your fundraising extras and launch your quiz fundraiser. We provide the questions, scoring, and player management tools.
              </p>
          ...
          <div className="group relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-white mb-4 text-xl font-bold">Host & Play</h3>
              <p className="text-white/80 text-base leading-relaxed">
                Run your fundraising quiz event online or in-person with auto-marking, team or individual scoring, and real-time leaderboards.
              </p>
          ...
          <div className="group relative">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-2xl border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              ...
              <h3 className="text-white mb-4 text-xl font-bold">Track & Report</h3>
              <p className="text-white/80 text-base leading-relaxed">
                Seamlessly reconcile cash and digital payments, and generate transparent, shareable records and winner logs.
              </p>
