...
export default function PuzzlePage() {
  ...
  // True when the player already submitted this puzzle in a prior session.
  // Causes the shell to start in a permanently locked completed state.
    ...
    puzzleService.loadPuzzle(challengeId, weekNumber)
      .then(data => {
        ...
        if (data.previousSubmission) {
          // Player already submitted — lock the shell and show their score
  ...
  if (locked) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
        ...
        <button
          onClick={() => navigate(`/challenges/${challengeId}/play`)}
