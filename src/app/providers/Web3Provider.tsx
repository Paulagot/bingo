...
// Web3 provider with lazy loading
...
export function Web3Provider({ children }: Web3ProviderProps) {
  ...
  const [WagmiProviderComponent, setWagmiProviderComponent] = useState<React.ComponentType<{ config: unknown; children: React.ReactNode }> | null>(null);
  const [QueryClientProviderComponent, setQueryClientProviderComponent] = useState<React.ComponentType<{ client: unknown; children: React.ReactNode }> | null>(null);
  const [wagmiConfig, setWagmiConfig] = useState<unknown>(null);
  const [queryClient, setQueryClient] = useState<unknown>(null);
