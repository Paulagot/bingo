...
ARG VITE_safeStreets
ARG VITE_SAFE_STREETS_ROOM_ID
ARG VITE_DONATION_CLUB_ID
...
ENV VITE_safeStreets=$VITE_safeStreets
ENV VITE_SAFE_STREETS_ROOM_ID=$VITE_SAFE_STREETS_ROOM_ID
ENV VITE_DONATION_CLUB_ID=$VITE_DONATION_CLUB_ID
