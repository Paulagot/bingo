 ...
 * IDL can be found at `target/idl/bingo.json`.
 */
export type Bingo = {
  "address": "8W83G9mSeoQ6Ljcz5QJHYPjH2vQgw94YeVCnpY6KFt7i",
  "metadata": {
    "name": "bingo",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Solana bingo platform with quiz rooms and prize distribution"
  },
  "docs": [
    "Fundraisely Program",
    "",
  ...
  "errors": [
    ...
    },
    {
      "code": 6038,
      "name": "joiningClosed",
      "msg": "Room is no longer accepting new players"
    },
    {
      "code": 6039,
      "name": "vaultNotEmpty",
      "msg": "Vault must be empty before cleanup"
    },
    {
      "code": 6040,
      "name": "insufficientAuthority",
      "msg": "Insufficient authority for this operation"
    }
  ],
  "types": [
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          },
          {
            "name": "joiningClosed",
            "docs": [
              "Whether new players can join (host can close joining early)"
            ],
            "type": "bool"
          },
          {
          ...
          },
          {
            "name": "winners",
            "docs": [
              "Declared winners (1-10, set by declare_winners instruction)"
            ],
            "type": {
              "vec": "pubkey"
            }
